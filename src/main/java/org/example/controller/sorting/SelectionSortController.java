...
import org.example.algorithm.sorting.SelectionSort;
import org.example.algorithm.sorting.impl.SelectionSortImpl;
...
public class SelectionSortController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/algorithms/sorting/selectionSort.jsp").forward(request, response);
    }
